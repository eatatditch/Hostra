            ...
            <Card>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-status-error">{summary.noShowCount}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between pt-2 border-t border-border">
                  ...
                  <span className="font-medium">{summary.avgPartySize.toFixed(1)}</span>
                </div>
              </div>
            </Card>
            <Card>
                ...
                <div className="flex justify-between pt-2 border-t border-border">
                  ...
                  <span className="font-medium">
                    {summary.waitlistJoins > 0
                      ? Math.round((summary.waitlistSeated / summary.waitlistJoins) * 100)
                      : 0}%
                  </span>
                </div>
              </div>
            ...
            {trend.map((day) => (
              <div key={day.date} className="flex items-center gap-4 text-sm">
                ...
                <div className="flex-1 flex items-center gap-2">
                  ...
                  />
                  <span className="text-xs font-medium">{day.covers} covers</span>
                </div>
                {day.noShows > 0 && (
                  <span className="text-xs text-status-error">{day.noShows} NS</span>
                )}
              </div>
            ))}
          </div>
